...
<tr><td>{% video /movies/qubit.mp4 /movies/qubit.ogv /movies/qubit.webm 504 326 /img/RL_bloch.png %}</td></tr>
</table>
\\
...
<tr><td>{% video /movies/many_qubits.mp4#t=0.3 /movies/many_qubits.ogv#t=0.3 /movies/many_qubits.webm#t=0.3 504 326 %}</td></tr>
</table>
\\
